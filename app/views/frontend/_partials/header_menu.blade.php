                ...
                <div class="col-sm-9">
                    <div id="nav-primary" class="nav-primary-wrap">
                        ...
                        <nav class="nav-primary" role="navigation">
                            ...
                            <a href="{{ URL::route('frontend.hotel.search') }}" class="nav-primary-item @if( strstr(Route::currentRouteName(),'frontend.hotel')) is-current @endif">
                                <span>{{ Lang::get('menus.spahotels') }}</span>
                            </a>
