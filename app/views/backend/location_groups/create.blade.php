...
@section('content')
	<div id="page-wrapper">
		<div class="row">
			<div class="col-sm-12">
				<h1 class="page-header"><a href="{{ URL::route('backend.location_groups') }}">Location Group</a> » Add</h1>
			</div>
        </div>
		<div class="row">
			<div class="col-md-12">
			{{ Form::open(array('url' => URL::route('backend.location_groups.store'))) }}
				<div class="row">
					<div class="col-sm-9">
					...
					<div class="col-sm-3">
						<div class="panel panel-default">
							<div class="panel-body">
								{{ Form::submit('Create location group', array('class' => 'btn btn-lg btn-primary btn-block')) }}
							</div>
						</div>
						<div class="panel panel-default">
							<div class="panel-body">
...
<script type="text/javascript">
    ...
    function deleteHotel(id) {
        if (confirm('Are you sure you want to delete this hotel from location?')) {
            ...
            /*
            $.ajax({
                url: "{{ URL::route('backend.location_groups.destroy_hotel', '') }}/" + id,
                type: "DELETE",
                success: function(response) {
                    alertify.success(response.content);
                    $('#hotels-list .js-remove-hotel-'+id).remove();
                }
            });
            */
        }
