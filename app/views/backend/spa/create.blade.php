...
@section('content')
	<div id="page-wrapper">
		<div class="row">
			<div class="col-sm-12">
				<h1 class="page-header"><a href="{{ URL::route('backend.spa') }}">Spa</a> » Add</h1>
			</div>
        </div>
		<div class="row">
			<div class="col-md-12">
			{{ Form::open(array('url' => URL::route('backend.spa.store'))) }}
				<div class="row">
					<div class="col-sm-9">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                {{ Form::text('spa_hotel', Input::old('spa_hotel'), array('class' => 'form-control')) }}
					...
					<div class="col-sm-3">
						<div class="panel panel-default">
							<div class="panel-body">
								{{ Form::submit('Create spa', array('class' => 'btn btn-lg btn-primary btn-block')) }}
							</div>
						</div>
						<div class="panel panel-default">
							<div class="panel-body">
