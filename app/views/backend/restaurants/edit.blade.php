...
@section('content')
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><a href="{{ URL::route('backend.restaurants') }}">Restaurants</a> » {{ $restaurant->name }}</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                {{ Form::model($restaurant, array('url' => URL::route('backend.restaurants.update', $restaurant->id), 'method' => 'PUT')) }}
                <div class="row">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('restaurant_hotel', $restaurant->hotel->name, array('class' => 'form-control')) }}
                                    {{ Form::hidden('hotel_id', $restaurant->hotel_id, array('id' => 'hotel_id')) }}
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-3">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                {{ Form::submit('Update restaurant', array('class' => 'btn btn-lg btn-primary btn-block')) }}
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-body">
                    ...
                    <div class="panel panel-default btn-">
                        <div class="panel-body">
                            ...
                            <div class="col-md-2 js-photo-button js-make-default-photo-{{ $photo->id }}">
                                ...
                                @if ( $photo->id == $restaurant->default_photo_id )
                                    <a href="javascript:makeDefault({{ $restaurant->id }}, {{ $photo->id }})" class="btn btn-block btn-success">Default</a>
                                @else
                                    <a href="javascript:makeDefault({{ $restaurant->id }}, {{ $photo->id }})" class="btn btn-block btn-default">Make default</a>
                                @endif
                            </div>
                            @endforeach
                        </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="clearfix">
                            <div class="pull-right">
                                {{ Form::hidden('content_type', 'restaurants') }}
                                {{ Form::hidden('content_id', $restaurant->id) }}
...
<script type="text/javascript">
    function makeDefault(restaurant_id, photo_id) {
        $.ajax({
            url: "{{ URL::route('backend.restaurants.make_default_photo', '') }}/" + restaurant_id+"/"+photo_id,
            type: "PUT",
